...
>   · **ตัวกรองประเภทต้องคง OP ไว้เสมอ ห้ามกรองทิ้ง** — กรองทิ้ง = *อ้าง* ว่า "OP นี้ไม่ใช่ประเภทนั้น" ซึ่งตอบไม่ได้
>     (หลัก "ไม่รู้ ≠ ไม่ใช่" เดียวกับ `unknown` ของ coverage) · `filterWipMatByCat` คืน `opKept` ให้จอเขียนอธิบาย
