...
>
> ### ⚠️ กฎเหล็ก 8 — เฟส 0: fixture จริงส่วนใหญ่ยัง **ติดป้ายผิดเป็น `equipment_kind='machine'`**
> ตรวจแล้วมี ~30+ ตัว (JHYD05-* · JHYD06-* · CENTERING · JIG SLIDELOAD · POKA-YOKE JIG · MARKING JIG · JIG SLIDE-1..3)
> — รวมจิ๊กเชื่อมของ **Line 60/61 ซึ่งเป็นไลน์นำร่อง** → ถ้าไม่จัดก่อน ทะเบียนจะว่างเปล่า
> · แท็บ 🏷️ ใช้ `suggestFixtureCandidates` **เสนอ + ให้ติ๊กเป็นชุด ระบบไม่ backfill เอง** (หลักเดียวกับทะเบียนแม่พิมพ์)
...
- **นำร่อง Line 60/61** (คำสั่ง user) — จิ๊กเชื่อมของ 2 ไลน์นี้จัดชนิดที่แท็บ 🏷️ ก่อน แล้วค่อยตั้งจุด
