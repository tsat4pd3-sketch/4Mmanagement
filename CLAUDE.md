...
> #### ⚠️ กฎเหล็ก 1 — "ใช้เครื่องไหน" มี 2 ระดับความแน่ชัด ห้ามนำเสนอปนกัน
> **🎯 ยืนยัน** = `prod_orders.machine_no` (มีเฉพาะไลน์ `flow_mode='parallel_machine'` ที่เลือกเครื่องตอนเปิดใบ)
> **⚙️ ผู้ต้องสงสัย** = เครื่องที่ลงทะเบียนในครอบครัวไลน์ — ระบบ**ไม่รู้**ว่าใบนี้วิ่งตัวไหนจริง
> ใบส่วนใหญ่ในระบบเป็นแบบหลัง → แผงขึ้นแบนเนอร์ส้มบอกตรงๆ ว่า "รายการล่างเป็นผู้ต้องสงสัย ไม่ใช่ข้อสรุป" + ชี้ทางปิดช่องว่าง (ตั้ง flow_mode แล้วเลือกเครื่องตอนเปิด Order)
> **ห้ามทำให้ผู้ต้องสงสัยดูเหมือนคำตอบ** — สอบกลับที่ชี้ผิดตัวแย่กว่าไม่มีข้อมูล
