...
> - **⚠️ `storage_zones` (WMS เฟส 1) ไม่ใช่ SLoc** — เป็นทะเบียน**โซนกองของในคลัง** ผูก mat แบบ array
>   ไม่ใช่ "ชิ้นส่วนบรรทัดนี้เบิกจากคลังไหน" ของ BOM รายบรรทัด · **ห้ามยุบรวมกัน**
