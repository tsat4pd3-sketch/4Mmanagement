...
| ภาพรวม | `/obeya` | **Obeya — 📋 บอร์ด KPI ส่วนงาน (SQCDM)** แทนกระดาษ "OBEYA KPI monitoring" ที่แปะผนังห้องประชุมหน้างาน · `?section=PD3&date=YYYY-MM-DD` (bookmark ต่อจอได้) · 6 การ์ด **S**afety/**Q**uality/**C**ost/**D**elivery/**M**orale/**P**roductivity · รายวัน + เทรนด์ 14 วัน + สะสมเดือนนี้ · **อ่านอย่างเดียว** ยกเว้นปุ่มบันทึกเหตุการณ์ความปลอดภัย · ดู section "OBEYA" | ทุก role (บันทึก Safety: `safety:record`) |
...
- **ยังไม่ทำ (เฟสถัดไป):** พิมพ์/PDF บอร์ด (ต้อง register `doc_forms` ตามกฎเอกสาร)
  ...
  · ยังไม่ได้ปรับให้ตรงกระดาษจริง — **ยังไม่เคยเห็นรูปบอร์ด OBEYA ของหน้างาน**
