...
| ภาพรวม | `/adoption-outlook` | **AdoptionOutlook — 🔮 ภาพเมื่อทุกแผนกใช้ครบ** ตอบผู้บริหาร "ถ้าทุกแผนกใช้เต็มรูปแบบจะได้อะไร" · 2 แท็บ: **ก่อน-หลัง รายแผนก** (วัดความครบของข้อมูลจากฐานจริง) + **เงินที่ประหยัดได้** (แปลงเวลาหยุด/ของเสียที่วัดได้เป็นบาท) · **อ่านอย่างเดียว** ทุกปุ่ม = ทางลัดไปหน้าที่ทำงานจริง (ดู section "Adoption Outlook") | admin/manager (seed) |
...
## Adoption Outlook — 🔮 ภาพเมื่อทุกแผนกใช้ครบ (`/adoption-outlook` · 2026-08-13)

หน้า `AdoptionOutlook.jsx` (กลุ่มภาพรวม) — ตอบผู้บริหารว่า **"ถ้าทุกแผนกใช้ระบบเต็มรูปแบบ จะได้อะไร"** เปิดในห้องประชุมแทนสไลด์ · **อ่านอย่างเดียว ไม่เขียน DB · ไม่มีตาราง/คอลัมน์ใหม่** (migration `20260813_adoption_outlook_permission.sql` seed สิทธิ์อย่างเดียว · apply แล้ว)

- **2 แท็บ (`useTabParam`):** 🏭 **ก่อน-หลัง รายแผนก** (default) · 💰 **เงินที่ประหยัดได้**
...
- **ยังไม่ทำ (เฟสถัดไป):** เทรนด์ adoption รายเดือน (ตอนนี้เป็นภาพ ณ ปัจจุบัน) · ผูก saving จริงจาก `improvements` เมื่อมีโปรเจคแล้ว (สูตรมีอยู่แล้วที่ `src/utils/costSaving.js`) · export เป็น .pptx ตาม template TSG
