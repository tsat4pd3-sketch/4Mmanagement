...
| **2, 3** (เบอร์ 200/300) | **พาร์ทย่อย** (Child) | ชิ้นส่วนที่ผลิตภายในเพื่อป้อนไลน์ประกอบ (ตรงกับป้าย "Store Child (200/300)" บนบอร์ด Kanban) | ปิดออเดอร์ → เข้า `STORE` → Store จ่ายเข้า mini-store ของไลน์ → backflush อัตโนมัติเมื่อ FG ปิดออเดอร์ |
