...
> → **`defect_recorded` seed มาโดย `inapp_roles` ว่างโดยตั้งใจ** (ของเสีย ~2.4 ครั้ง/วัน และจะโตตาม adoption) — Telegram ก่อน ใครอยากได้ในแอคค่อยติ๊กเองที่ `/notification-config`
