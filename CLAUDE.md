...
- **เฟสถัดไป (ยังไม่ทำ):** scale calibration (หน่วยผัง→เมตร) · empty_return · เชื่อม AMR fleet จริง (kind='charge' + สถานะหุ่น — เฟส 3)
