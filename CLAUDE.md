...
>
> ##### 📥 โหมด `assumeZeroWip` — "ยังไม่ตั้งจุด WIP ก็ให้เห็น workflow ไปก่อน" (2026-09-01 · คำสั่ง user)
> *"ทางสโตร์ไม่เห็นความต้องการจากฝ่ายผลิตเลย ถ้ายังไม่ตั้งจุด WIP ถ้าจะให้เห็นการจำลอง workflow
> เรามอง WIP=0 ไปก่อนได้มั้ย เพราะยังไง BOM ของ FG ก็มีครบแตกหาพาร์ทย่อยหมดแล้ว"*
> ถูกต้อง: **ความต้องการ (`need`) จาก BOM แม่นอยู่แล้ว ที่ไม่รู้คือ "หักได้เท่าไหร่"**
> ⇒ WIP=0 = **ยอด gross ซึ่งเป็นความจริงที่ยังไม่หัก ไม่ใช่การเดา** · ไม่มีโหมดนี้ = จอว่าง 29/31 พาร์ท
...
>   · ปิดโหมดแล้วขึ้นแถบชวนเปิดพร้อมจำนวนพาร์ทที่คำนวณไม่ได้ (ห้ามเงียบทั้งสองทาง)
