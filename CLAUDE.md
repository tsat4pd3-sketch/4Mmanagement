...
| **2** (เบอร์ 200) | **พาร์ทย่อย** (Child) | ชิ้นส่วนที่ผลิตภายในเพื่อป้อนไลน์ประกอบ | ปิดออเดอร์ → เข้า `STORE` → Store จ่ายเข้า mini-store ของไลน์ → backflush อัตโนมัติเมื่อ FG ปิดออเดอร์ |
