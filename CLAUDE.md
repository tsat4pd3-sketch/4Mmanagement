...
- **💰 Cost Saving (2026-08-11 · คำสั่ง user):** การ์ดโปรเจคแปลงผลก่อน/หลังเป็น **บาท/วัน + บาท/เดือน + ระยะคืนทุน** — โมเดล standard costing ของบัญชี:
  ...
  - **⚠️ บัญชีปรับ rate รอบใหม่ = เพิ่มแถวใหม่ที่ `effective_from` ห้าม update ทับ** (โปรเจคเก่าต้องคำนวณด้วย rate ณ ช่วงเวลานั้น) · ชุดแรก seed ที่ `effective_from='2000-01-01'` เพื่อครอบโปรเจคที่มีอยู่แล้ว
