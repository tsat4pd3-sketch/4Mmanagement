...
> ⚠️ **ก่อนแก้ UI ใดๆ ให้อ่าน `docs/UI-CONVENTIONS.md` ก่อนเสมอ และทำตามอย่างเคร่งครัด** — กติกากลาง:
> marker บนผัง (วงกลม+ป้ายใต้ เท่านั้น, สูตร MK + clamp), ตรรกะ Andon เขียว-เหลือง-แดง (กระพริบเฉพาะแดง),
> ฟอนต์ขั้นต่ำ 11–12px, การ์ด grid สูงเท่ากัน, สิทธิ์ action ผ่าน `can()` ห้าม hardcode role array เพิ่ม
> ถ้างานสร้าง/เปลี่ยน pattern ที่ใช้ร่วมหลายหน้า ต้องอัพเดทไฟล์นั้น (พร้อมวันที่) ในคอมมิทเดียวกัน
