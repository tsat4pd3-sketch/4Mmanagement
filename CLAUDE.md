...
- **เฟสถัดไป (ยังไม่ทำ):** ลาก/ย้ายช่องที่ตีไว้แล้ว (ตอนนี้แก้ได้แค่เปลี่ยนรหัส/ลบแล้วตีใหม่) · QR ต่อช่องให้สแกนแล้วเด้งเข้าอะไหล่ในช่องนั้น · เชื่อมกับใบเบิกในขั้นซ่อม MO (กดจากใบแล้วผังชี้ช่องให้เดินไปหยิบ)
