...
> ✅ **ครบทั้ง 5 รอบ + ปิดเรื่อง backfill แล้ว 2026-08-24** — ตรวจกับฐานจริง (user รันคิวรีใน SQL Editor):
> · **T1-5 = 0 กะ** — ไม่มีกะปิดแล้วที่มีของเสียติดธงงานทดลอง (ธงเพิ่งมี 17/8 ยังไม่มีใครติ๊ก → ค่า stamp เดิมถูกทุกกะ)
> · **T3-1 = 0 กะ** — ไม่มีกะปิดแล้วที่ oee เป็น null ทั้งที่มีใบ carry_over มียอดจริง
> ⇒ **ไม่ต้อง backfill อะไรเลย** (ตรงตามข้อ 1 ของ user: "แบคฟิลเฉพาะพิสูจน์ได้" — พิสูจน์แล้วว่าไม่มี)
> เหลือ T3 รายย่อยที่ไม่เข้ารอบไหน ทยอยเก็บตามโอกาสเมื่อไปแตะไฟล์นั้น
>
