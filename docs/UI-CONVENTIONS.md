...
- **โมเดล 3D จริง:** component กลาง `src/components/Model3DViewer.jsx` (three.js orbit + auto-rotate, three โหลด dynamic) — reuse แทนเขียน viewer 3D ใหม่ · แปลงไฟล์เป็น GLB ด้วย `src/lib/model3d.js` · หน้าที่มีทั้งรูปและโมเดลให้มีปุ่มสลับ 📷 รูป / 🧊 3D (ดู PMCheckData/PMSetup)
