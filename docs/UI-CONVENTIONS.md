...
```
[รายวัน|รายสัปดาห์|รายเดือน|รายปี]  ย้อนหลัง [30|60|90|120] วัน  [จาก] ถึง [ถึง] (90 วัน)  {children}  [🔄 โหลด]
```

- สเกล/กรอบเวลาผูกกับ URL ผ่าน `useTimeRange()` (`?scale=&from=&to=`) — เจาะจากบอร์ดแล้วพาตัวกรองไปด้วย
- **ปุ่มย้อนหลังไม่ใช่โหมด** — กดแล้วเติมวันลงช่อง แก้วันต่อเองได้ทันที
