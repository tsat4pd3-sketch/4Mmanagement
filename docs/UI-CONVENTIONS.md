...
## 6. ไทม์ไลน์ / บอร์ด Heijunka (2026-07-09)

- **Playhead เวลาปัจจุบัน**: ใช้ CSS กลาง `.now-line` (เส้นชมพู #ec4899 + หัวลูกศร + pulse) และ
  `.now-chip` (ป้ายเวลาลอยบนหัวตารางตรงตำแหน่งเส้น) — สีชมพูสงวนให้ playhead เท่านั้น ห้ามใช้กับสถานะงาน
  บอร์ดไทม์ไลน์ใหม่ทุกตัวต้องมีทั้งเส้นและป้ายเวลา
- **โครงบอร์ด 2 กะ "พาร์ทละ 1 บล็อก"**: ป้าย+รูปพาร์ทใหญ่ 1 อันครอบ 2 แถบเวลา (☀️ 08–20 บน / 🌙 20–08 ล่าง)
  หัวชั่วโมงแสดงเวลาคู่บน-ล่างในคอลัมน์เดียวกัน — ห้ามกลับไปวาดแยกบล็อกเช้า/ดึกซ้ำป้ายพาร์ท
  (ต้นแบบ: Heijunka บน Dashboard และหน้าจัดการไลน์)
