...
1. 🔴 **แถวการ์ดต้องมี "พระเอก" 1 ใบ** ถ้าใบในแถวไม่ได้สำคัญเท่ากัน — ตัวเลขใหญ่กว่า + กินคอลัมน์มากกว่า
   · เลือกใบที่เป็น **ผลรวม/ตัวตัดสิน** ไม่ใช่ใบที่ชอบ · `/oee-analytics`: **OEE = A × P × Q**
     ⇒ OEE เป็นพระเอก 46px · A/P/Q เป็น "ตัวประกอบ" 28px และเขียนสูตรไว้ใต้ใบ OEE
   · **ข้อยกเว้น:** ชุดที่เป็นพี่น้องกันจริง (OEE/OOE/TEEP ที่ต่างกันแค่ฐานเวลา) ควรเท่ากันทั้งแถว
     — `uxsweep` คอลัมน์ `แถวไร้พระเอก` จึงเป็น **"ควรดู" ไม่ใช่ "ผิด"**
