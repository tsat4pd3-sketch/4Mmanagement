...
3. **แกนซ้าย = ค่า เริ่มที่ 0 เสมอ** ห้ามตัดฐาน
...
- **เลขค่าบนหัวแท่งชนกับ % ของเส้นสะสม** เมื่อค่าใกล้กัน (25/24/23…) เพราะเส้นพาดผ่านหัวแท่งพอดี
  ⇒ วางเลขไว้ **ในแท่ง** และเลือกฝั่งที่เส้นไม่ผ่าน (เส้นต่ำ → วางบน · เส้นสูง → วางล่าง)
