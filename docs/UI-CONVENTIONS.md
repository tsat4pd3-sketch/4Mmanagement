...
`Login` (มีแบรนด์เอง) · `Dashboard` · `Management` · `LineOeeBoard` (`/line-oee`) · **`/tv` (จอเฝ้าระวังแขวนห้อง — ไม่มี sidebar/กระดิ่งด้วย)** · `LineSetup` (ถูกฝังในแท็บหน้าอื่น)
