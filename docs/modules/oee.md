...
| ③ สแกนคู่ "A & B" = 2 OP | `30047596 & 30052451` | `291 (M6 มีเกลียว)` + `FENDER` | 40 / 53 | 6,056 |
| ③ | `30052454 & 30047593` | `5049 (SPOT)` (อีกครึ่งไม่มี OP) | 56 | 5,833 |
| ④ ไม่มีในทะเบียนจริง | `50029377` (Laser LWR) · `M10/M6 ไม่มีเกลียว` · `10100387` | — | — | 18,646 |
...
**ยังไม่แก้ — รอ user ตัดสิน 2 ข้อ:** (ก) ใบสแกนคู่ `A & B` = ทำ 2 OP พร้อมกัน (CT ต้องบวกกัน)
หรือเป็นงานประกอบตัวเดียวที่กินชิ้นส่วน 2 ตัว (CT ตัวเดียว) · (ข) `M6/M10 ไม่มีเกลียว` ในใบผลิต
คือ `E025 (M6/M10 ไม่มีเกลียว)` ใช่ไหม
