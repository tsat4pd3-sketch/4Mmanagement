...
>     · seed แล้ว 2 ขั้น (`90031601`/`90031602` → บลังค์ `50031601` ×1 pcs · migration `20260915_scrap_op_bom_deduct.sql`
>       **apply แล้ว 15/09**) ที่เหลือ **จงใจไม่ seed** (ห้ามเดาว่าขั้นขับนัทกินนัตกี่ตัว) — จอเตือนให้คนไปผูกเอง
