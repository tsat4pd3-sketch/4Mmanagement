...
### ⏭️ ยังไม่ได้ทำ (เรียงตามที่ตกลงกับ user)
1. **เก็บใบรายงานปัญหาเป็นบันทึก** — ตอนนี้ generate ใหม่ทุกครั้ง · หัวเรื่อง "ปัญหา :" ที่คนพิมพ์หายทันที ·
   ไม่รู้ว่าเคยออกใบเมื่อไหร่/ใครออก ทั้งที่ FM-PD1-019 ต้องเก็บ 1 ปี
2. โมดัล 🗑️ ลงถัง ให้ลงจบในที่เดียว (ผู้ทำลาย/ตำแหน่ง/QA/ผลซ่อม) + ลิงก์กลับไปใบถัง
3. **นาฬิกาอายุแท็ก 5 วัน / 1 วัน** + จอเตือนของค้างถัง
4. เติมทางเลือก **"งานดี"** (§5.4) และ **"ขอใช้" FM-QA-042** ให้ครบ 3 ทางตาม WI
5. ผูกทะเบียน QRs ↔ WI ซ่อม (§6) เข้าโมดัลลงวิธีแก้ไข
