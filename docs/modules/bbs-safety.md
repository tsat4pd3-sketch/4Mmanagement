...
- **📱 โหมดมือถือ (2026-09-07 · รีวิวฟังก์ชันตรวจสอบบนมือถือ — จอ ≤768px):** เลือกวัน ◀ ▶ → การ์ดต่อคน → กดชิป 4 สัญลักษณ์ (44px)
  · กด "ไม่เหมาะสม" กางเลขข้อตกลงใต้การ์ด · กดชิปเดิมซ้ำ = ล้าง · "ทาแล้ว x/N คน" + ปุ่มไปวันนี้ · desktop = ตาราง+แปรงเดิมเป๊ะ
  · `paint(emp, day, markOverride, seqOverride)` รับ mark ตรงได้ (ไม่ผ่านแปรง) · หมายเหตุท้ายแถวยังกรอกได้เฉพาะจอใหญ่ (บอกไว้ใต้ลิสต์)
  · pattern กลาง → `docs/UI-CONVENTIONS.md` §6.12 (ต้นแบบสำหรับเช็คชื่อ/LPA ต่อไป)
