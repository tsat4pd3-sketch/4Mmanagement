...
- **⚙️ แท็บ "รายอุปกรณ์ (MTTR/MTBF)" — Downtime · MTTR · MTBF รายตัว (2026-09-11 · คำขอทีม MTN)**
  ...
  · UI = `src/components/MachineReliability.jsx` · **สูตรทั้งหมดอยู่ `src/utils/mtnMetrics.js` (pure · เทส 12 เคส) ห้ามคำนวณเองในหน้า**
  ...
  - **ยังไม่ทำ:** export ไฟล์ไปเทียบกับระบบส่วนกลาง (ทำเมื่อไหร่ต้อง register `/doc-forms` ตามกฎเอกสาร) · กราฟแนวโน้มรายเดือน · ยังไม่มี "ทะเบียนชื่อเล่นเครื่อง" (alias) ให้ map ชื่อที่คนพิมพ์เข้ากับเลขจริง
