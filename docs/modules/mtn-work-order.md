...
### 3) ขั้น 6 / ขั้น 7 แยกกันเหมือนเดิม ("แยก 2 ขั้น")
- ขั้น 6 = **ฝั่งผู้แจ้ง** รับมอบ + ประเมินความพึงพอใจ + เจ้าของค่าใช้จ่าย (เหมือนทุกฟอร์ม)
- ขั้น 7 ของใบ MTN = **ฝั่งช่าง** "รับรองงาน / ปิดใบ MO (ผจก.ส่วนซ่อมบำรุง)" ตรงกับช่องเซ็นบนกระดาษ
  (`sg('รับรองโดย (ผจก.ส่วนซ่อมบำรุง)', o.approver_name, …)`) — override อยู่ที่ `MTN_FORM_STEPS[7]` ใน `mtnStepPerm.js`
- ⚠️ ขั้น 7 ของใบ MTN ตั้ง `reporterSide: false` **ตั้งใจ** — ถ้าปล่อยให้เป็นขั้นของ "ฝ่ายที่แจ้ง" ผจก.ซ่อมบำรุง
  ที่ถูกตั้ง `sections` ไว้จะปิดใบของไลน์อื่นไม่ได้เลย · ขั้น 6 ยังคุมด้วย scope ฝ่ายที่แจ้งตามเดิมทั้ง 2 ฟอร์ม
- ป้ายขั้น/หัวโมดัล/กล่อง "ขั้นนี้เป็นหน้าที่ของ" อ่านจาก `stepMeta(step, { mtnForm })` — **ห้ามอ่าน `MTN_STEPS[n]` ตรงๆ ในหน้าอีก**
