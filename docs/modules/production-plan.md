...
> 5. ⏱️ **เฟส 1 ยังไม่เลื่อนวันตาม lead time** — งานของลูกถูกวางไว้ **วันเดียวกับดิวของแม่**
>    ซึ่งมองโลกในแง่ดีเกินจริง (ของจริงลูกต้องเสร็จก่อน) · `explodeDemandByDate(..., offsetDays)` รองรับไว้แล้ว
>    **จอเขียนบอกข้อนี้ตลอดเวลา ห้ามถอดออก**
>
