...
>
> - **⭐ กติกาใหม่: e-SMART อัพเดทใบ 862 ที่เวลาส่งตกใน `(windowStart, targetAt]` — ไม่สร้างรอบใหม่**
>   **ยืนกริดของ 862 ไว้ · ห้ามแก้ `ship_time`** (ยืนยันออเดอร์ ≠ เลื่อนเวลาส่ง)
>   · เจอหลายใบในช่วง = อัพเดท**ใบที่ใกล้เวลารับสุด** · ที่เหลือขึ้น **⚠ extras บนพรีวิว ระบบไม่แตะ ให้คนตัดสิน**
>   · ไม่มีใบ 862 ในช่วงเลย = สร้างใหม่ที่ `targetAt` (พาร์ทที่ลูกค้าเรียกนอกแผน)
