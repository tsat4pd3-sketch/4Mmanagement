...
- **จุดที่พาไปผูกสูตร (2026-09-15):** `/products` แท็บสินค้ามีแถบส้ม **"🧩 ขั้นตอน (OP) ที่ยังไม่ผูก component N รายการ"**
  — ชิป mat กดได้ เด้งไปแท็บ BOM แล้ว**เลือกแถวนั้นให้เลย** (`?tab=bom&mat=…` · ล้าง `mat` ทิ้งหลังเลือก
  กันค้างตอน refresh · หาไม่เจอ = toast แดง ไม่เงียบ) · ในฟอร์มแก้ OP (กล่อง 🔩) มีปุ่ม
  **"🧩 ตั้ง component ของขั้นนี้ →"** บอกจำนวนที่ผูกแล้วในตัว — ปุ่มโผล่เฉพาะตอนแก้ของที่บันทึกแล้ว
