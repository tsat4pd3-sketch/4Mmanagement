...
>
> ⚠️ **ผัง PDF ทั้ง 2 ใบเป็นภาพสแกน ไม่มี text layer** และสแกนจางมาก — กล่องส่วนใหญ่ใน ORG-001
> **อ่านไม่ออกเลย** (อ่านได้แค่ `ฝ่าย Logistic and Sales` กับ `ส่วน Maintenance Cost 2140456000`)
> ⇒ ข้อมูล "ชื่อหน่วย" ด้านล่างมาจาก **แม่แบบ xlsx + ทะเบียน `org_divisions` ที่มีอยู่แล้ว**
> ไม่ใช่จากการอ่านผังรวม · **ก่อนยึดเป็นความจริง ให้ขอไฟล์ต้นฉบับ (ไม่ใช่สแกน) มายืนยัน**
