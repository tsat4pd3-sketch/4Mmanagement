...
> ⚠️ **เลขของ PD2 ยังต้องยืนยัน 1 หลัก** — user พิมพ์มา `214047000` (9 หลัก)
> แต่ผังทางการเขียน `2140470000` (10 หลัก) · เลือกใช้ค่าจากผังเพราะ cost center ของทุกส่วน
> ในฝ่าย Production เป็น 10 หลักรูปแบบ `21404xxxxx` เหมือนกันหมด
> ถ้า 9 หลักถูกจริง → แก้ด้วย migration ใหม่ **ห้ามแก้ค่าในฐานตรงๆ**
