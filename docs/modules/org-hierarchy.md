...
#### เทียบ PD1-PD4 กับส่วนจริง (จับคู่ด้วย cost center)

| ของเรา | Cost | ส่วนจริงที่ cost ตรงกัน | หัวหน้าที่ระบบผูกไว้ | หัวหน้าตามผัง |
|---|---|---|---|---|
| **PD1** | 2140461000 | ✅ `Press Production` | ศักดา | ศักดา ✅ |
| **PD3** | 2140462000 | ✅ `Hydroforming` | ดุลยทรรศน์ | ดุลยทรรศน์ ✅ |
| **PD2** | 2140471000 | `Assembly 2` | **ศิริพร** | **ดุลยทรรศน์** 🔴 |
| **PD4** | 2140472000 | 🔴 **ไม่มี cost นี้ในผัง** | ดุลยทรรศน์ (ผ่าน sections) | — |
| — | 2140470000 | `Assembly 1` (ศิริพร) | 🔴 **ไม่มีในระบบ** | ศิริพร |
| PLN & STO | 2140429000 | ✅ `Log&Sales/Planning&Store` | — | วิทยา |

> **🔴 PD2/PD4 ขัดกันเอง 2 แหล่ง — ห้ามเดา ต้องให้คนชี้**
> · ถ้าเชื่อ **cost center**: PD2 = Assembly 2 ⇒ ศิริพรผูกผิดส่วน
> · ถ้าเชื่อ **ตัวคน**: PD2 = Assembly 1 ⇒ cost center ของ PD2 ใส่เลขของ Assembly 2 ไว้
> · และ PD4 (`2140472000`) ไม่มีคู่ในผังเลยทั้งสองทาง
> ⇒ **ตัวกรอง/แจ้งเตือนที่เดินผ่าน PD2/PD4 วันนี้ ชี้ไปผิดส่วนอย่างน้อย 1 ใน 2**
