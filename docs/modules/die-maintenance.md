...
### ค้างไว้ (รอคำตอบช่างปั๊ม / คำสั่ง user)
1. **ตัวเลขจริง:** Δ ความสูงเท่าไหร่จึงมีผล · แต่ละขั้นบวกกี่นาที · เวลาฐาน/ตัวเดิมเปลี่ยนล็อตกี่นาที
2. **ข้อจำกัดอื่นนอกจากความสูง:** tonnage · bolster · feeder · จำนวนชุดช่างเซ็ตอัพ
...
4. **ชั้น 2 (ลากการ์ดจัดแผน · `plan_seq`/`planned_start_at`) และชั้น 3 (optimizer)** — ยังไม่เริ่ม
   · คำถามที่ต้องตอบก่อน: ใครลากแผนได้ · แผน "ชนะ" หรือ "แพ้" การสแกนจริงหน้างาน
