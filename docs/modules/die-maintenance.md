...
### ⏸️ พักไว้ก่อน (user 2026-09-25: *"พักเรื่อง die height ไว้ก่อน มีรายละเอียดมากกว่านั้น"*)

ของที่ทำไปแล้ว (ชั้น 1) **ใช้งานได้ครบและไม่ค้างครึ่งทาง** — กรอกความสูง/กฎได้ทันที ไม่มีอะไรรอปิดงาน
🔴 **session ถัดไปห้ามเดินหน้าต่อเอง** (ทั้งชั้น 2-3 และการขยายกฎ setup) — user แจ้งว่างานปั๊มจริง
มีรายละเอียดมากกว่าที่คุยกันไว้ และจะให้ข้อมูลเพิ่มเอง · รอโจทย์ชุดใหม่ก่อนค่อยออกแบบต่อ
(ที่จดไว้ด้านล่างคือสถานะ ณ ตอนพัก ไม่ใช่ backlog ให้หยิบทำ)
