...
> **📌 เลือกฉบับให้ตรงกับผู้เรียนก่อน**
> - **ฉบับนี้ (เต็ม · 6 ชม. · 71 สไลด์)** — ผู้เรียนพอมีพื้นไอที/อยากเขียนโค้ดจริง · ใช้ React + Vite + terminal + build
> - **ฉบับพื้นฐาน (4 ชม. · 44 สไลด์ · EN+ไทย)** — `docs/WEB101_Basic_Slides_EN_TH.html` + คู่มือผู้สอน `docs/WEB101_BASIC_TRAINER_GUIDE_EN_TH.md` · สำหรับ**คนไม่เป็นไอทีสอนคนไม่เป็นไอที** ไม่มี terminal ไม่มี npm ไฟล์เดียวจบ
