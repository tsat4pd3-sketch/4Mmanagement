...
EN = dict(
    ...
    built=[("Platform", "React 19 &middot; PostgreSQL &middot; realtime sync"),
           ...
           ("Maths", "TPM / AIAG standard formulas &mdash; <b>no AI in the decision path</b>")],
...
TH = dict(
    ...
    built=[("แพลตฟอร์ม", "React 19 &middot; PostgreSQL &middot; อัปเดตสด"),
           ("อุปกรณ์", "จอ TV หน้าไลน์ &middot; แท็บเล็ต &middot; มือถือ (ติดตั้งได้)"),
           ("แจ้งเตือน", "ในแอป &middot; เด้งมือถือ &middot; Telegram แยกเรื่อง"),
           ("การควบคุม", "{roles} ระดับสิทธิ์ &middot; {forms} ฟอร์มควบคุม &middot; มีประวัติการแก้ไข"),
           ("การคำนวณ", "สูตรมาตรฐาน TPM / AIAG &middot; <b>ไม่ใช้ AI ตัดสินใจ</b>")],
