...
| ✅ ฝั่ง DB apply ครบแล้ว 2026-08-25 (#10/#18 · #11/#17 · #12 · #20 · #23 · #26/#27/#32) | — |
...
| 26 | 🔴 | Store ชั้นใน | `supabase/migrations/20260821_store_abnormal_view.sql:40` | เคส C ของ v_store_abnormal ไม่ frame-aware — รอบหลังเที่ยงคืน (00:00-07:59) หลุดผ่านตัวกรอง hour<20 แล้วถูกตีเป็น "เลยเวลา" ปลอม | ✅ apply แล้ว 2026-08-25 (v2 + v3 — A 33→28 · เคส C ปลอมหาย · E 2,336→52 แถว) |
| 27 | 🟡 | Store ชั้นใน | `supabase/migrations/20260821_store_abnormal_view.sql:29` | เคส A/B เทียบ min/max ระดับ "ต่อ mat" กับ on-hand ระดับ "ต่อ location" + แถว (line,mat) ที่ net เป็น 0 ค้างในวิวตลอดกาลแล้วยิง sev 3 รายวัน | ✅ apply แล้ว 2026-08-25 (v2 + v3 — A 33→28 · เคส C ปลอมหาย · E 2,336→52 แถว) |
...
| 32 | 🔵 | Store ชั้นใน | `supabase/migrations/20260821_store_abnormal_view.sql:42` | นิยาม dwell ของเคส C ใช้ coalesce(...,0) ต่างจาก default (points··1)×(min··10) ของ getRoundStatus — drift ชนิดที่วิวถูกสร้างมาเพื่อฆ่า | ✅ apply แล้ว 2026-08-25 (v2 + v3 — A 33→28 · เคส C ปลอมหาย · E 2,336→52 แถว) |
...
- **ไฟล์:** `supabase/migrations/20260821_store_abnormal_view.sql:40` · **โดเมน:** Store ชั้นใน: LineStock / WIP / StoreMonitor · **สถานะ:** ✅ apply แล้ว 2026-08-25 (v2 + v3 — A 33→28 · เคส C ปลอมหาย · E 2,336→52 แถว)
...
- **ไฟล์:** `supabase/migrations/20260821_store_abnormal_view.sql:29` · **โดเมน:** Store ชั้นใน: LineStock / WIP / StoreMonitor · **สถานะ:** ✅ apply แล้ว 2026-08-25 (v2 + v3 — A 33→28 · เคส C ปลอมหาย · E 2,336→52 แถว)
...
- **ไฟล์:** `supabase/migrations/20260821_store_abnormal_view.sql:42` · **โดเมน:** Store ชั้นใน: LineStock / WIP / StoreMonitor · **สถานะ:** ✅ apply แล้ว 2026-08-25 (v2 + v3 — A 33→28 · เคส C ปลอมหาย · E 2,336→52 แถว)
