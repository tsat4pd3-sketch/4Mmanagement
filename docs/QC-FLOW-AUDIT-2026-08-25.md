...
| 12 | 🟡 | ผลิต FG → เข้าคลังอัตโนมัติ | `supabase/migrations/20260820_op_items_never_enter_stock.sql:17` | OP guard มีอยู่แค่ใน DB — ไฟล์ migration ล่าสุดในรีโปที่ create or replace fn_post_confirmed_output (20260714) ไม่มี guard → replay/ยกร่างครั้งหน้า guard หายเงียบ | 🔴 รอ DB dump — commit เวอร์ชันจริงเข้ารีโป |
...
- **ไฟล์:** `supabase/migrations/20260820_op_items_never_enter_stock.sql:17` · **โดเมน:** ผลิต FG → เข้าคลังอัตโนมัติ · **สถานะ:** 🔴 รอ DB dump — commit เวอร์ชันจริงเข้ารีโป
