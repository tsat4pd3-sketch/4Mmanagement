...
| 26 | 🔴 | Store ชั้นใน | `supabase/migrations/20260821_store_abnormal_view.sql:40` | เคส C ของ v_store_abnormal ไม่ frame-aware — รอบหลังเที่ยงคืน (00:00-07:59) หลุดผ่านตัวกรอง hour<20 แล้วถูกตีเป็น "เลยเวลา" ปลอม | 📝 migration พร้อมแล้ว `20260825_store_abnormal_frame_aware.sql` (DR) — **รอ user รัน** |
| 27 | 🟡 | Store ชั้นใน | `supabase/migrations/20260821_store_abnormal_view.sql:29` | เคส A/B เทียบ min/max ระดับ "ต่อ mat" กับ on-hand ระดับ "ต่อ location" + แถว (line,mat) ที่ net เป็น 0 ค้างในวิวตลอดกาลแล้วยิง sev 3 รายวัน | 📝 migration พร้อมแล้ว `20260825_store_abnormal_frame_aware.sql` (DR) — **รอ user รัน** |
...
| 32 | 🔵 | Store ชั้นใน | `supabase/migrations/20260821_store_abnormal_view.sql:42` | นิยาม dwell ของเคส C ใช้ coalesce(...,0) ต่างจาก default (points··1)×(min··10) ของ getRoundStatus — drift ชนิดที่วิวถูกสร้างมาเพื่อฆ่า | 📝 migration พร้อมแล้ว `20260825_store_abnormal_frame_aware.sql` (DR) — **รอ user รัน** |
...
- **ไฟล์:** `supabase/migrations/20260819_demand_flow_routing.sql:128` · **โดเมน:** ระเบิด BOM + backflush + accumulator · **สถานะ:** 📝 migration พร้อมแล้ว `20260825_demand_blocks_show_capped.sql` (DR) — **รอ user รัน** · ฝั่งจอ (FlowTower/StoreLotQueue) รองรับ block_reason แล้ว
...
- **ไฟล์:** `supabase/migrations/20260821_store_abnormal_view.sql:40` · **โดเมน:** Store ชั้นใน: LineStock / WIP / StoreMonitor · **สถานะ:** 📝 migration พร้อมแล้ว `20260825_store_abnormal_frame_aware.sql` (DR) — **รอ user รัน**
...
- **ไฟล์:** `supabase/migrations/20260821_store_abnormal_view.sql:29` · **โดเมน:** Store ชั้นใน: LineStock / WIP / StoreMonitor · **สถานะ:** 📝 migration พร้อมแล้ว `20260825_store_abnormal_frame_aware.sql` (DR) — **รอ user รัน**
...
- **ไฟล์:** `supabase/migrations/20260821_store_abnormal_view.sql:42` · **โดเมน:** Store ชั้นใน: LineStock / WIP / StoreMonitor · **สถานะ:** 📝 migration พร้อมแล้ว `20260825_store_abnormal_frame_aware.sql` (DR) — **รอ user รัน**
