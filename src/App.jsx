...
// 📋 OBEYA — บอร์ด KPI ส่วนงาน แทนกระดาษที่แปะผนังห้องประชุมหน้างาน
...
export const NAV_ITEMS = [
  ...
  /* 📋 OBEYA — แทนกระดาษ "OBEYA KPI monitoring" ที่แปะผนังห้องประชุมหน้างาน
     กริดตามบอร์ดจริง: คอลัมน์ = กลุ่มไลน์ × 8 หัวข้อ + ป้าย G/Y/R · deep-link ?section=PD3 ต่อจอ */
  { to: '/obeya', icon: '📋', label: 'บอร์ด KPI ส่วนงาน (OBEYA)', group: 'จอแสดงผล' },
