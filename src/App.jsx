...
export const NAV_ITEMS = [
  ...
  { to: '/pm-check',    icon: '✅', label: 'บันทึกผลตรวจ PM',                 group: 'การตรวจสอบและซ่อมบำรุง' },
  { to: '/pm-schedule', icon: '📅', label: 'ปฏิทินแผน PM',                    group: 'การตรวจสอบและซ่อมบำรุง' },
  { to: '/pm-forecast', icon: '🔧', label: 'PM ที่จะครบกำหนด',                group: 'การตรวจสอบและซ่อมบำรุง' },
  ...
  { to: '/pm-setup',    icon: '🔩', label: 'ตั้งจุดตรวจ PM',                  group: 'การตรวจสอบและซ่อมบำรุง' },
