...
/* ชนิดอุปกรณ์ → ทีมที่ "ปกติ" ดูแล · ทีมตั้งต้นของ picker จากเครื่อง
   ⚠️ เป็นการ **เดา** ไม่ใช่ข้อเท็จจริง — ตัวตัดสินจริงคือ `mtn_orders.mtn_dept` (ใบซ่อม) ·
      `downtime_logs.call_mtn_team` (เรียกช่าง) · `checklists.department` (งานตรวจ)
      ตามกฎเหล็ก "ชนิดอุปกรณ์ไม่ได้ล็อกว่าใครตรวจ"
   → จอที่กรองด้วยตัวนี้ **ห้ามซ่อนของที่กรองออกเงียบ** ต้องบอกจำนวนเสมอ
   นิยามจริงอยู่ `mtnTeamGuess.js` (pure ไม่ import supabase ⇒ เทสเรียกได้) — ที่นี่แค่ re-export */
export { teamForEquipmentKind, guessTeamFromName, teamForMachine } from './mtnTeamGuess.js'
