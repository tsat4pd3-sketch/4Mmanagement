...
const PAGE_GROUPS = [
  ...
  },
  {
    ...
    pages: [
      ...
      { key: 'page:/pm-check',    label: 'บันทึกผลตรวจ PM' },
      { key: 'page:/pm-schedule', label: 'ปฏิทินแผน PM' },
      { key: 'page:/pm-forecast', label: 'PM ที่จะครบกำหนด' },
      ...
      { key: 'page:/pm-setup',    label: 'ตั้งจุดตรวจ PM' },
    ],
  },
  {
