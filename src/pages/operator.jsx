        ...
        <div>
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 12, padding: '14px 16px', marginBottom: 14 }}>
            ...
            <div style={{ fontSize: 11.5, color: 'var(--muted)', lineHeight: 1.6 }}>
              ระบบสะสมคะแนนอัตโนมัติ (+1/วัน) ทำงาน<b>เฉพาะจุดงานที่ตั้งเกณฑ์ตั้งแต่ 70 ขึ้นไป</b>เท่านั้น —
              สกิลที่เพิ่งสร้างหรือตั้งเกณฑ์ต่ำกว่านั้นจะไม่โตเอง ต้องประเมินให้ที่หน้านี้
              มิฉะนั้นพนักงานจะไม่ผ่านเกณฑ์จุดงาน แล้วการจัดคนจะติด 4M ขออนุมัติทุกครั้ง
            </div>
          </div>
