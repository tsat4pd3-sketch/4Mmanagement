            ...
            {reports.map(rep => (
              <tr key={rep.id}>
                ...
                <td style={{ ...tdSt, whiteSpace: 'nowrap' }}>
                  <button style={{ ...ghostBtn, padding: '4px 10px' }} onClick={() => doPrint(rep)}>🖨️ PDF</button>
                  <button style={{ ...ghostBtn, padding: '4px 10px', marginLeft: 4 }} onClick={() => doExport(rep)}>⬇ Excel</button>
