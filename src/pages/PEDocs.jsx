...
export default function PEDocs() {
  ...
  // ทะเบียนที่ picker ใช้ (2026-09-07): Product Master เช็ค MAT SAP ตอนบันทึก · ผังองค์กรสำหรับหน่วยงานใน FMEA/CP
  ...
  const procFamLine = procModal?.line_name || curSet?.line_name || '';
