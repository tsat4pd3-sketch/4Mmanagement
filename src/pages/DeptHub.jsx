...
const DEPTS = [
  ...
  },
  {
    ...
    route: '/bom',
    available: true,
    desc: 'BOM แตกพาร์ทย่อยของ product + Heijunka Kanban demand รายวัน',
    modules: ['BOM', 'Heijunka Kanban'],
  },
  {
    key: 'warehouse',
    label: 'Warehouse',
  ...
  },
  {
    ...
    available: true,
    desc: 'แผน PM, บันทึกผลการตรวจสอบ, ติดตามสถานะอุปกรณ์',
    modules: ['PM Setup', 'PM ตรวจสอบ', 'แผน PM'],
  },
  {
    key: 'jig',
    ...
    route: '/pm-check?dept=jig_maintenance',
    available: true,
    desc: 'บำรุงรักษา JIG & Fixture, วัดค่า Variable/Attribute',
    modules: ['PM Setup', 'PM ตรวจสอบ', 'แผน PM'],
  },
];
